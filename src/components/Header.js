  ...
  return (
    <>
      <div className={`z-[999] h-[50px] w-full  ${dark ? 'bg-black text-white' : 'bg-white'} mx-auto items-center top-0 flex justify-between border-b border-[#808080] md:h-[80px] ${ScrollActive ? 'fixed' : 'absolute'}`}>
        ...
        <ul className='flex items-center hidden mr-3 text-2xl cursor-pointer md:flex md:block'>
      ...
      <div className={`bg-white z-[998] fixed top-0 w-[500px] h-full md:hidden ${isActive ? `right-0` : `-right-[500px]`}`}>
