      ...
      <img src='/images/profile.jpg' alt='프로필' className='mb-10 rounded-lg shadow-lg md:basis-2/5 md:w-auto' id='profile' />
        <div className=''>
          <ul className='basis-[40%] md:basis-full text-justify'>
            ...
            <li className={`text-[12px] ${dark ? `text-[#d4d4d4]` : `text-[#636363]`} mb-5 w-[500px] md:text-2xl`}>끊임없이 도전하며 자기계발을 추구하고, 항상 더 나은 개발자로 성장하려는 열망을 가지고 있습니다.</li>
            <li className={`text-[12px] ${dark ? `text-[#d4d4d4]` : `text-[#636363]`} mb-5 w-[500px] md:text-2xl`}>사용자 경험을 개선하고 웹 애플리케이션을 만드는 것을 좋아하며,</li>
            <li className={`text-[12px] ${dark ? `text-[#d4d4d4]` : `text-[#636363]`} mb-7 w-[500px] md:text-2xl`}>빠르게 변화하는 기술 트렌드를 따라가고, 항상 학습과 개선에 열린 자세를 유지합니다.</li>
