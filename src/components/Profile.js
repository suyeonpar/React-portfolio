      ...
      <img src='/images/profile.jpg' alt='프로필' className='mb-10 rounded-lg shadow-lg w-[70%] md:basis-2/5 md:w-auto' id='profile' />
        <div className=''>
          <ul className='mx-auto text-justify md:basis-full'>
            ...
            <li className={`text-xs mb-2 w-[79%] mx-auto ${dark ? `text-[#d4d4d4]` : `text-[#636363]`} md:mb-7 md:w-[620px] md:text-2xl`}>끊임없이 도전하며 자기계발을 추구하고, 항상 더 나은 개발자로 성장하려는 열망을 가지고 있습니다.</li>
            ...
            <li className={`text-xs mb-5 w-[79%] mx-auto mb-1 ${dark ? `text-[#d4d4d4]` : `text-[#636363]`} md:mb-7 md:w-[622px] md:text-2xl`}>빠르게 변화하는 기술 트렌드를 따라가고, 항상 학습과 개선에 열린 자세를 유지합니다.</li>
            <NavLink to='/about'><span className='cursor-pointer ml-11 text-sm text-[#ddd] transition-[1s] hover:text-[#5E5BE3] md:text-2xl md:ml-0'>자기소개 더 보기</span></NavLink>
          </ul>
        </div>
      </div>
    </div>
