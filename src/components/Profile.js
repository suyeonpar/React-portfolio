      ...
      <img src='/images/profile.jpg' alt='프로필' className='mb-10 rounded-lg shadow-lg w-[70%] md:basis-2/5 md:w-auto' id='profile' />
        <div className=''>
          <ul className='mx-auto text-justify md:basis-full'>
            ...
            <li className={`bg-black rounded-md text-center text-white p-1 w-28 md:w-52 mt-2 md:mt-3 cursor-pointer ml-[10.5%] text-xs ${dark ? `border` : ``} hover:scale-[1.1] transition-[1s] md:text-2xl md:ml-0`}><NavLink to='/about'>자기소개 더 보기</NavLink></li>
          </ul>
        </div>
      </div>
    </div>
