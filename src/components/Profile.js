      ...
      <img src='/images/profile.jpg' alt='프로필' className='mb-10 rounded-lg shadow-lg w-[70%] md:basis-2/5 md:w-auto' id='profile' />
        <div className=''>
          <ul className='mx-auto text-justify md:basis-full'>
            ...
            <li className={`text-center text-sm md:text-2xl lg:text-3xl ${dark ? `text-white` : `text-black`} mb-7 md:text-center md:w-full`}>저는 프론트엔드 개발자로의 <span className='text-[#5E5BE3] text-xl font-extrabold md:text-3xl lg:text-[35px]'>도전</span> 을 즐깁니다.</li>
            ...
            <NavLink to='/about'><li className='mt-2 md:mt-3 cursor-pointer ml-[10.5%] text-xs text-[#ddd] transition-[1s] hover:text-[#5E5BE3] md:text-2xl md:ml-0'>자기소개 더 보기</li></NavLink>
          </ul>
        </div>
      </div>
    </div>
