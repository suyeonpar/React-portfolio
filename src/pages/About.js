...
function About({ dark, toggleDarkMode }) {
  ...
  const data = [
    ...
    },
    {
      ...
      desc3: ["그린 컴퓨터아트학원 - 2023.06.29 ~ 2023.11.30","공부", "그린 온라인 캠프 - 2023.09 ~ 2023.10", "Deep Dive - 2023.09 ~", "자바스크립트의 이해를 돕고자 정독"]
    }
  ]
