...
function Slide({ dark }) {
  ...
  return (
    ...
    <div className={`h-[40px] w-[60%] leading-[40px] bg-[#010b1a] border rounded-md overflow-hidden relative text-center mx-auto ${dark ? `border-gray-200` : ``} md:h-[60px] w-[60%]`}>
    <div className='flex w-[82%] h-full justify-between mx-auto md:w-[80%] lg:w-[85%] items-center'>
      ...
      <div className="relative flex justify-center items-center w-full h-[450px] mt-20 mx-auto mb-[150px] bg-black">
